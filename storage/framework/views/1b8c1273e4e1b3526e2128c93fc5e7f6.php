                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <button type="button" data-toggle="modal" data-target="#modalDelete"
                          data-url="<?php echo e(route('produk.destroy', [
                            'produk' => $produk->id,
                            ])); ?>"
...
<div class="card-footer">
  <?php echo e($produks->links('vendor.pagination.bootstrap-4')); ?>
...
<?php endif; ?>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', ['title' => 'Produk'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kasir-toko\resources\views/produk/index.blade.php ENDPATH**/ ?>